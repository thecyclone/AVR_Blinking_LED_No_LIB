...
elf_file = blinking_led.elf              #This is the variable created to store the elf file
c_file = blinking_led.c                  #This is the variable created to store the c file
hex_file = blinking_led.hex              # It is the variable created to store the hex file
objs = blinking_led.elf blinking_led.hex # This variable stores all the object files that will be created during the execution of code
